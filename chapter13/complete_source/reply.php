...
<input type=hidden name=parent_depth value=<?php echo $parent_row[depth]?>>
<input type=hidden name=parent_thread value=<?php echo $parent_row[thread]?>>
...
<td align=left >
<INPUT type=text name=title size=60 maxlength=35 value="<?php echo $parent_title?>">
</td>
</tr>
<tr>
<td width=60 align=left >내용</td>
<td align=left >
<TEXTAREA name=content cols=65 rows=15><?php echo $parent_content?></TEXTAREA>
</td>
</tr>
<tr>
